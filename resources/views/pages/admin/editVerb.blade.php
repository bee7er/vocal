                    ...
                    <form id="editVerbForm" action="" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div style="text-align: right;padding-right: 15px;">
                                <button type="button" class="btn btn-default btn-verb" onclick="cancelEdit()">
                                    <i class="fa fa-btn fa-home"></i>Cancel
                                </button>
                                <button type="button" class="btn btn-default btn-verb" onclick="updateVerb('verbForm', '{{ url('/updateVerb')}}')">
